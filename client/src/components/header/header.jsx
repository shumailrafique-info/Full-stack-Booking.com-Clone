...
const Header = ({ hidden = true }) => {
  ...
  const handleOption = (name, action) => {
    setOptions((prev) => {
      return {
        ...prev,
        [name]: action === "inc" ? options[name] + 1 : options[name] - 1,
      };
    });
  };
  ...
  return (
    <div className="header">
      <div
        className={`${hidden ? "headerContainer" : "headerContainer listmode"}`}
      >
        ...
        {hidden && (
          <>
            ...
            <p className="headerDescription">
              ...
              more with a free Booing account
            </p>
            ...
            <div className="headerSearch">
              ...
              <div className="headerSearchItem">
                ...
                {openOptions && (
                  <div style={{ zIndex: 1000 }} className="options">
